...
if __name__ == "__main__":
    ...
    # Visualize with interactive filters and statistics
    print("🚀 Starting IFC Visualization with Interactive Filters...")
    print("="*80 + "\n")
    
    visualize_ifc_with_trimesh(ifc_url, show_statistics=True)
